...
* Download [Bootstrap 3](http://getbootstrap.com/) to sites/all/libraries/kalatheme_bootstrap, if you haven't already.
...
* Run "compass compile" to overwrite the css in sites/all/libraries/kalatheme_bootstrap/css with your customized Bootstrap styles.
